...
# Problem 2, Part 1: Given a list of 'passwords', determine how many of them are valid.
...
# Problem 2, Part 2: Similar to above, except the range describes positions that must contain only one occurence of the desired letter.
